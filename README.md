...
Logo depois de instalar o plugin HCL temos realizar uma configuração em Settings > Tools > Terraform > Terraform path, para que sejamos capazes de poder utilizar o Terraform pela própria IDE .
